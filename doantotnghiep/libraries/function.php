...
<?php 
    ...
    */
    ...
    function base_url(){
        ...
        return $url = "http://brostech.me/doantotnghiep";
    }

    function asset_admin(){
        return base_url() . "/asset/admin/";
    }

    function asset_frontend(){
        return base_url() . "/asset/frontend/";
    }

    
    function asset_uploads(){
        return base_url() . "/asset/uploads/";
    }
    ...
    // 
    if(! function_exists('redirectWeb')){
